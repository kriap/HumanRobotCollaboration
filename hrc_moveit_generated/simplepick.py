...
GRIPPER_FRAME = 'l_wrist_roll_joint'
...
GRIPPER_JOINT_NAMES = ['l_gripper_link']
...
class TestPick():
    def __init__(self):
        ...
        start_pose.pose.position.x = 0.899
        start_pose.pose.position.y = 0.299
        start_pose.pose.position.z = 0.999
        ...
        while result == False:
            result = robot.left_arm.pick("part", grasps)       
            n_attempts += 1
